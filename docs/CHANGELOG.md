...
- **Flex recipe:** ship `security_nowo_workflow.yaml` access rules (REQ-SEC-004). Prefer **`^1.6.5`** over `v1.6.4`.

## [1.6.4] - 2026-08-19

### Security

- **Flex recipe:** `security.access_control` for workflow routes (REQ-SEC-004).
